    ...
    <main className="flex-grow pt-16 flex items-center justify-center min-h-[calc(100vh-64px)] bg-surface-container-high px-lg py-xl">
      ...
      >
        <div className="flex flex-col gap-2 text-center">
          <h1 className="font-h2 text-h2 text-on-surface">Welcome Back</h1>
          <p className="font-body-md text-on-surface-variant">Sign in to your AgriExpert Connect account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 relative">
            <div className="flex justify-between items-center">
              ...
              <Link to="/forgot-password" className="font-label-sm text-primary hover:underline">Forgot password?</Link>
            </div>
        ...
        <div className="flex items-center gap-4 py-4">
          ...
          <span className="font-caption text-on-surface-variant uppercase">Or continue with</span>
          <div className="flex-1 h-px bg-outline-variant"></div>
        </div>
        ...
        <div className="flex justify-center">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 rounded-lg border border-outline-variant hover:bg-surface-container transition-colors shadow-sm font-label-md text-on-surface"
          >
